...
# ------------------ EDUCATION ------------------
degree_pattern = "(?i)\\b(bachelor\\s+of\\s+engineering|bachelor\\s+of\\s+technology|b\\.?\\s*e\\.?|b\\.?\\s*tech|m\\.?\\s*e\\.?|m\\.?\\s*tech|bsc|msc|diploma|xii|XII|X|12\\s*th|h\\.?\\s*s\\.?\\s*c|x|10\\s*th|s\\.?\\s*s\\.?\\s*l\\.?\\s*c|matric)\\b"
